...
browseButton = tk.Button(
    text="     Select File     ", command=getFile, bg="green", fg="white", font=("helvetica", 12, "bold")
)
...
saveAsButton = tk.Button(
    text="Convert to PDF", command=convertToPdf, bg="green", fg="white", font=("helvetica", 12, "bold")
)
...
exitButton = tk.Button(
    root, text="Exit Application", command=exitApplication, bg="brown", fg="white", font=("helvetica", 12, "bold")
)
